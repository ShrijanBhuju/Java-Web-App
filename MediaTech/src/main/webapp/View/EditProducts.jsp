        ...
        <header>
            ...
            <div class="right">
                <form action="${pageContext.request.contextPath}/search" class="search-bar">
                    <input type="text" name="item-name" class="search-field" placeholder="Search this Website"
                ...
                <% String email=null; if(session.getAttribute("loggedInId")==null){ %>
                    <div class="middle">
                        ...
                        <%} else{ email=session.getAttribute("loggedInId").toString(); %>
                            <h1 class="intro">You are Logged In as <%= email %>
                            </h1>
            ...
            <form action="updateproductData" method="post" enctype="multipart/form-data">
                <div class="top">
                    ...
                    <div class="right2">
                        ...
                        <input type="file" id="prod-image file" name="image" class="imageChooser" value="profile-eg.png"
                            onchange="onImageChange()" />
                    </div>
                </div>
                <div class="bottom">
                    <button type="submit" value="Add Product">Update Product</button>
                    <a href="${pageContext.request.contextPath}/manageproducts">Cancle</a>
